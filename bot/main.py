...
containerFileList = ["Supercontainer.json", "SantasGift2021.json", "SantasBigGift2021.json", "SantasMegaGift2021.json", "SantasGift2022.json", "SantasBigGift2022.json", "SantasMegaGift2022.json", "SantasGift2023.json", "SantasBigGift2023.json", "SantasMegaGift2023.json", "SantasGift2024.json", "SantasMegaGift2024.json"] #list of container data .json file names
    ...
    if '!collection'.lower() in message.content.lower() and message.content[0] == "!":
        ...
        if len(content) == 5 and content[1].isdigit() and content[2].isdigit() and content[3].isdigit() and content[4].isdigit():
            ...
            if n > 100:
                ...
                collectionmessage = "```"
                collectionmessage += "\nOn average, you will need to open " + str(round(totalcontainers / runs, 1)) + " containers."
                collectionmessage += "\nThe standard deviation for number of containers needed to complete the collection is " + str(round(stdev, 1)) + "."
